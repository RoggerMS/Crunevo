...
def global_search_api():  # Renamed to avoid conflict
    ...
    results = {"apuntes": [], "tienda": [], "temas_sugeridos": []}
        ...
        results["apuntes"].append(
            {
                ...
                "title": apunte.title,
                "description_snippet": (
                    apunte.description[:100] + "..."
                    if apunte.description and len(apunte.description) > 100
                    else apunte.description
                ),
