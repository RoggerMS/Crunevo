...
5.  **Configurar Variables de Entorno:**
    ...
    *   Verifica que `DATABASE_URI` apunte a la ubicación correcta de tu base de datos. Si usas SQLite, la ruta actual (`sqlite:////ruta/completa/a/deployment_cantuta_app/src/instance/plataforma_apuntes.db`) debe ser correcta y el directorio `src/instance` debe tener permisos de escritura.
