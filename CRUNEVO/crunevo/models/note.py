...
class Note(db.Model):
    ...
    download_records = db.relationship('Download', back_populates='note', lazy=True, cascade="all, delete-orphan")
...
class Download(db.Model):
    ...
    __table_args__ = (db.UniqueConstraint('user_id', 'note_id', name='uq_user_note_download'),)
...
class Like(db.Model):
    __tablename__ = 'likes'
    __table_args__ = (db.UniqueConstraint('user_id', 'note_id', name='uq_user_note_like'),)
